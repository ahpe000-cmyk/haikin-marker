...
const SettingsModal = ({ active, activeId, charter, setCharter, prompts, setPrompts, showApiKey, apiKey, setApiKey, workspaceId, setWorkspaceId, onClose, onSave, isMobile }) => (
